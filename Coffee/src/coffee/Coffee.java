...
private final String kodeBrg = "Brg";
    ...
    protected String namaBrg, tanggal;
    public int stokAwal,stokMasuk,stokKeluar,hargaBeli,hargaJual;
    private Coffee Brg;
    
    Coffee(String namaBrg, String tanggal, int stokAwal, int stokMasuk, int stokKeluar, int hargaBeli, int hargaJual, long noKodeBrg){
    ...
    public Coffee getBrg() {
        return Brg;
    }

    public ArrayList<Coffee> getBrgList() {
        return BrgList;
    }
    ...
    Coffee cfe;
    ArrayList<Coffee> BrgList = new ArrayList<>();
    ...
    protected void tambahBarang () throws IOException{
        boolean ulang=true;
        System.out.println("\nMenambahkan Barang Coffee Shop\n");
        ...
        while(ulang){
            ...
            if (strHargaJual.equals("0")){
                ...
                try{
                    ...
                    cfe = new Coffee(namaBrg, tanggal, stokAwal, stokMasuk, stokKeluar, hargaBeli, hargaJual, noKodeBrg); // OBJEK ke - 1
                    BrgList.add(cfe);
                    System.out.println("\n>> Tambah Data Barang Coffee Shop Berhasil <<");
                    ulang=false;
    ...
    protected void tampilBarang(){
        System.out.println("\nMenampilkan Barang Coffee Shop \n");
        for (int i=0; i<BrgList.size(); i++){
            ...
            System.out.println("Tanggal Masuk : " + BrgList.get(i).gettanggal());
    ...
    public ArrayList<Coffee> ubahBarang(ArrayList<Coffee> Brglist) {
        int ubah;
        System.out.println("\nMengubah Data Barang Coffee Shop\n");
        for (int i=0; i<BrgList.size(); i++){
        ...
        BrgList.get(ubah).tanggal = (inp.nextLine());
        ...
        System.out.println("\n>> Data Barang Coffee Shop Berhasil Di Ubah <<\n");

        return BrgList;
    }
    
    public void hapusBarang() {
        System.out.println("\nMenghapus Barang Coffee Shop\n");
        for (int i=0; i<BrgList.size(); i++){
            System.out.println("No Kode Barang : " + kodeBrg +
            BrgList.get(i).getNoKodeBrg());
            System.out.println("Nama Barang : " + BrgList.get(i).getNamaBrg());
        ...
        System.out.println("\n>> Barang Coffee Shop Berhasil di Hapus <<\n");
    }
